...
class meeylandSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        data = '{"category":"5deb722db4367252525c1d16","filter":"{\"attributes\":{},\"seoUrl\":\"\",\"date\":{\"startDate\":\"2001-01-19T17:00:00.000Z\",\"endDate\":\"2020-11-06T16:59:59.999Z\"}}","sort":"{\"createdDate\":-1}","skip":0,"limit":20,"search":""}'
    ...
    def parse_page(self, response):
        ...
        for page in range(1,number_page+1):
            ...
            data = '{"category":"5deb722db4367252525c1d16","filter":"{\"attributes\":{},\"seoUrl\":\"\",\"date\":{\"startDate\":\"2001-01-19T17:00:00.000Z\",\"endDate\":\"2020-11-06T16:59:59.999Z\"}}","sort":"{\"createdDate\":-1}","skip":'+str((page-1)*20)+',"limit":20,"search":""}'
